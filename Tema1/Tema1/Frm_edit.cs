...
{  
    public partial class Frm_edit : Form
    {
        ...
        private void but_gata_Click(object sender, EventArgs e)
          {
              if (rtf_nume.Text == "")
              {
                  MessageBox.Show("Contactul trebuie sa aiba un nume!");
                  return;
              }
                 variabile.ds.Tables[0].Rows.Remove(variabile.ds.Tables[0].Rows[cont]);
                 variabile.ds.Tables[0].Rows.Add(rtf_nume.Text, rtf_numar.Text, rtf_email.Text);
                 dgv.DataSource = variabile.ds.Tables[0];
